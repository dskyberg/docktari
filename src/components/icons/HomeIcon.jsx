...
const HomeIcon = forwardRef(({ size }, ref) => (
  <svg
    ref={ref}
    title="Home Icon"
  ...
  >
    <g id="dashboard-3--app-application-dashboard-home-layout-vertical">
      <path
        ...
        fill="#fddc5c"
        fillRule="evenodd"
        d="M1.25 0.75h4c0.27614 0 0.5 0.223858 0.5 0.5v6c0 0.27614 -0.22386 0.5 -0.5 0.5h-4c-0.276142 0 -0.5 -0.22386 -0.5 -0.5v-6c0 -0.276142 0.223858 -0.5 0.5 -0.5Zm7.5 5.5h4c0.2761 0 0.5 0.22386 0.5 0.5v6c0 0.2761 -0.2239 0.5 -0.5 0.5h-4c-0.27614 0 -0.5 -0.2239 -0.5 -0.5v-6c0 -0.27614 0.22386 -0.5 0.5 -0.5Z"
        clipRule="evenodd"
        strokeWidth="1"
      ></path>
      <path
